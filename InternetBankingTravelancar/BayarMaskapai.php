    ...
    <body>
        ...
        <div class="flex-container" >
            <div class="flex-item-0" style="width:  50%" align="center">
                ...
                <h1 id="form_header">Pembayaran Booking Tiket Maskapai disini !</h1>
            </div>
        </div>

        <div class="flex-container" >
            <div class="flex-item-1">
        <form action="formbayarMaskapai.php" method="POST">
            ...
            <table align="center">
                ...
                <tr>
                    ...
                    <td>ID Order Tiket Maskapai</td>
                    <td>:</td>
                    <td>
                        <input type="text" name="id_order_tiket" id="id_order_tiket" placeholder="" >
                        <br>
                    </td>
                </tr>
