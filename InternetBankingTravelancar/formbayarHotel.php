...
if($link === false){
    die("ERROR: Could not connect. " . mysqli_connect_error());
		...
		$id_booking_htl =  mysqli_real_escape_string($link, $_REQUEST['id_booking_htl']);
		$tgl_pembayaran =  mysqli_real_escape_string($link, $_REQUEST['tgl_pembayaran']);
  
	$sql = "INSERT INTO bukti_pembayaran (id_pembayaran, id_bank_pbyr, id_booking_htl, tgl_pembayaran) VALUES ('$id_pembayaran', '$id_bank_pbyr', '$id_booking_htl', '$tgl_pembayaran')";
